...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/0.99.98/SendbirdChatSDK.zip", :sha1 => "617dbf5bf1e3d797019c855487e3db3ec6ae704a" }
  s.requires_arc = true
  s.platform = :ios, '13.0'
  s.documentation_url = 'https://sendbird.com/docs/chat'
  s.ios.vendored_frameworks = 'SendbirdChatSDK/SendbirdChatSDK.xcframework'
  s.dependency 'SendbirdAuthSDK', '1.1.3'
