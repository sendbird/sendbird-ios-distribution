...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/sendbird/sendbird-chat-sdk-ios/releases/download/0.99.99/SendbirdChatSDK.zip", :sha1 => "f86e4cc40c95a61ea9be2be54d4b1fca69a66275" }
  s.requires_arc = true
  s.platform = :ios, '13.0'
