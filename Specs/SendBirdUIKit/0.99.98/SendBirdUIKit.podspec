Pod::Spec.new do |s|
	...
	s.platform = :ios, "13.0"
	s.source = { :http => "https://github.com/sendbird/sendbird-uikit-ios/releases/download/#{s.version}/SendBirdUIKit.zip", :sha1 => "b834d3409a6c67b994becfd0e1d9351d1b83ea71" }
